...
export default async function AddPage(){
 ...
 return <main className="shell addCustomerShell"><AppHeader title="お客様を追加" rightHref="/plans" rightLabel={access.plan==="free"?(sourceAvailable?`${customers.length}/30`:"Free"):access.plan==="pro"?"Pro":"B"}/>
