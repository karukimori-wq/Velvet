...
export function CaptureComposerForm({ action, groups, sections, knownTags, phase, voiceAllowed, placeholder }: { action: CaptureComposerAction; groups: RememberGroup[]; sections?: RememberSection[]; knownTags: string[]; phase: "first" | "repeat"; voiceAllowed: boolean; placeholder: string; }) {
