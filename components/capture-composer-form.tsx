...
export function CaptureComposerForm({ action, groups, sections, knownTags, recentFieldLabels=[], phase, voiceAllowed, placeholder }: { action: CaptureComposerAction; groups: RememberGroup[]; sections?: RememberSection[]; knownTags: string[]; recentFieldLabels?: string[]; phase: "first" | "repeat"; voiceAllowed: boolean; placeholder: string; }) {
  ...
  return <form action={formAction} className="stack captureForm">
    <CaptureChatInput groups={groups} sections={sections} knownTags={knownTags} recentFieldLabels={recentFieldLabels} phase={phase} voiceAllowed={voiceAllowed} placeholder={placeholder}/>
