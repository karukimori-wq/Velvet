...
export function CaptureComposerForm({ action, groups, sections, knownTags, recentFieldLabels=[], frequentFieldLabels=[], phase, voiceAllowed, placeholder }: { action: CaptureComposerAction; groups: RememberGroup[]; sections?: RememberSection[]; knownTags: string[]; recentFieldLabels?: string[]; frequentFieldLabels?: string[]; phase: "first" | "repeat"; voiceAllowed: boolean; placeholder: string; }) {
