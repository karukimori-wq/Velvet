...
const checks = [
  ...
  ["JSON export API is Pro gated", exportApi.includes('hasVelvetFeature(access,"export.data")') && /PRO_REQUIRED/.test(exportApi)],
  ["JSON export UI reflects entitlement", importPage.includes('hasVelvetFeature(access,"export.data")') && /Proで利用できます/.test(importPage)],
