...
const files=["README.md","docs/current-product-contract.md","docs/development-roadmap.md","docs/ui-spec.md","docs/domain-model.md","docs/data-model.md","docs/database-schema.md","docs/persistence-setup.md","docs/billing-ai-points.md","docs/auth-permissions.md","docs/api-spec.md","docs/production-readiness.md","docs/product-principles.md","docs/coding-rules.md","docs/component-library.md","docs/ai-capabilities.md"];
const text=files.map(file=>`${file}\n${fs.readFileSync(file,"utf8")}`).join("\n\n");
const failures=[];
const assert=(condition,message)=>{if(!condition)failures.push(message)};

assert(text.includes("990 JPY/month")||text.includes("990 JPY / month")||text.includes("990 JPY/month"),"Current docs must preserve the Pro 990 JPY target");
