...
const config=fs.readFileSync("next.config.js","utf8");const addAction=fs.readFileSync("app/add/actions.ts","utf8");const addPage=fs.readFileSync("app/add/page.tsx","utf8");const addForm=fs.readFileSync("components/add-customer-form.tsx","utf8");const failures=[];const assert=(condition,message)=>{if(!condition)failures.push(message)};
